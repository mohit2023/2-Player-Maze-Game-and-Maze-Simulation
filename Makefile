...
IMG = -lSDL2_image
builddeps = Maze.o Vector2D.o TextureManager.o Map.o GameObject.o Game.o main.o
buildobjs = bin/Maze.o bin/Vector2D.o bin/TextureManager.o bin/Map.o bin/GameObject.o bin/Game.o bin/main.o
all: $(builddeps)
