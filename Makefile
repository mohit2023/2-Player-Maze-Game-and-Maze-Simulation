...
IMG = -lSDL2_image
builddeps = Maze.o TextureManager.o Map.o GameObject.o Game.o main.o
buildobjs = bin/Maze.o bin/TextureManager.o bin/Map.o bin/GameObject.o bin/Game.o bin/main.o
all: $(builddeps)
